...
public class FrmPesquisar extends JFrame{
    ...
    JLabel lblTitulo = new  JLabel("Pesquisar Cadastro ");
    ...
    public FrmPesquisar (){
        ...
        //botão pesquisar
        btnPesquisar.setBounds(50, 693, 400, 50);
        ...
        btnPesquisar.setToolTipText("Tecle para pesquisar um ou varios clientes cadastrados..");
